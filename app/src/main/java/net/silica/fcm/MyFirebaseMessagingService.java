...
import net.silica.R;
import net.silica.dao.OkHttpUtil;
...
//        }//
    ...
    private void handleNotification(RemoteMessage.Notification RemoteMsgNotification) {
        ...
        String iconUrl = RemoteMsgNotification.getIcon();
        NotificationFCM notificationFCM = new NotificationFCM();
        notificationFCM.setTitle(title);
        notificationFCM.setMessage(message);
        notificationFCM.setIconUrl(iconUrl);

        Intent resultIntent = new Intent(getApplicationContext(), MainActivity.class);
        NotificationUtils notificationUtils = new NotificationUtils(getApplicationContext());
        notificationUtils.displayNotification(notificationFCM, resultIntent);
        notificationUtils.playNotificationSound("1");
    }
    ...
    private void handleData(Map<String, String> data) {
        ...
        notificationFCM.setMessage(message);
        notificationFCM.setIconUrl(iconUrl);
        notificationFCM.setAction(action);
        notificationFCM.setActionDestination(actionDestination);
